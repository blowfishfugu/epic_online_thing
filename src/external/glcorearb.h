...
typedef void (APIENTRYP PFNGLSTENCILFUNCPROC) (GLenum enfunc, GLint ref, GLuint mask);
typedef void (APIENTRYP PFNGLSTENCILOPPROC) (GLenum fail, GLenum zfail, GLenum zpass);
typedef void (APIENTRYP PFNGLDEPTHFUNCPROC) (GLenum enfunc);
...
typedef void (APIENTRYP PFNGLSTENCILFUNCSEPARATEPROC) (GLenum face, GLenum enfunc, GLint ref, GLuint mask);
...
typedef void (APIENTRYP PFNGLPATHSTENCILFUNCNVPROC) (GLenum enfunc, GLint ref, GLuint mask);
...
typedef void (APIENTRYP PFNGLPATHCOVERDEPTHFUNCNVPROC) (GLenum enfunc);
